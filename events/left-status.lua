...
local M = {}
local status_label = custom.get('name.status_label', 'noid')
...
cells
	...
	:add_segment('mode_label', status_label, colors.default, attr(attr.intensity('Bold')))
	:add_segment(
		'scircle_right',
...
local function resolve_mode(window)
	...
	return GLYPH_DEFAULT_MODE, status_label
end

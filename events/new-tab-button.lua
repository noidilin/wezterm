...
local launch_menu = require('config.launch-menu').launch_menu
...
-- stylua: ignore
local colors = {
   label_text   = { fg = palette.mono15 },
   icon_default = { fg = palette.mono17 },
   icon_wsl     = { fg = palette.mono21 },
   icon_ssh     = { fg = palette.acc05 },
   icon_unix    = { fg = palette.green00 },
}
